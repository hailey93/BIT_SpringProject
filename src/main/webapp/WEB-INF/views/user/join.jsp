	...
	<div class="headerBtm">
		<div>
			...
			<div align="center">
				<h1>회원가입</h1>
				<hr>
				<form action="joinProcess.do" id="signFrm" name="signFrm"
					method="post">
					<fieldset>
						<table>
							<tbody>
								<tr>
									...
									<td><input type="text" id="id" name="id"
										class="inputTextType1"></td>
									<td><input type="button" id="check"
										style="cursor: pointer" class="inputTextType1" value="중복체크"></td>
								</tr>
								<tr>
								...
								<tr>
									<td>이름</td>
									<td><input type="text" id="name" class="inputTextType1"
										name="name"></td>

								</tr>
								<tr>
									<td>패스워드</td>
									<td colspan="2"><input id="pw" name="pw"
										class="inputTextType1" type="password"></td>
								</tr>
								<tr>
									<td>패스워드 확인</td>
								...
								<tr>
									<td>생일</td>
									<td><input type="date" id="birth" class="inputTextType1"
										name="birth"></td>
								</tr>
								<tr>
									<td>성별</td>
									<td>남자<input type="radio" name="gender" value="남자"
										checked="checked"> 여자<input type="radio" id="gender"
										name="gender" value="여자"></td>

								</tr>
								<tr>
									<td>핸드폰번호</td>
									<td><input type="text" id="phone" class="inputTextType1"
										name="phone"></td>
								</tr>
					...
					<div align="center" class="buttons">
						<input type="button" id="signUp" value="회원가입 완료"> 
